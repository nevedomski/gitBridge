...
sys.modules["gitbridge.browser_sync"] = mock_browser_sync

from gitbridge.cli import cli, init, main, status, sync, validate  # noqa: E402
...
class TestCLIGroup:
    ...
    def test_cli_group_help(self):
        ...
        assert "GitBridge - Synchronize GitHub repositories" in result.output
    ...
    def test_main_function(self):
        ...
        with patch("gitbridge.cli.cli") as mock_cli:
            main()
...
class TestInitCommand:
    ...
    def test_init_basic(self, mock_config_class):
        ...
        assert "gitbridge sync --config test_config.yaml" in result.output
...
class TestSyncCommand:
    ...
    @patch("gitbridge.cli.GitHubAPISync")
    @patch("gitbridge.cli.Config")
    ...
    @patch("gitbridge.cli.GitHubBrowserSync")
    @patch("gitbridge.cli.Config")
